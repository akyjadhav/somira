            ...
            <div class="container py-5" style="max-width: 1400px;">
                <div class="row g-4">
                    ...
                    <div class="product-info-block col-md-6  ps-5">
                        ...
                        <div class="row g-2 col-sm-12 mb-3 product-swatch">
                            <div class="col col-sm-auto col-12 col-md-6 size-swatch">
                            ...
                            <div class="col col-sm-auto col-12 col-md-6 feature-swatch">
                                <select class="form-select bg-theme-color4 p-3">
                        ...
                        <div class="col-md-9 mt-5 qty-box bg-theme-color3">
                            <div class="variation-box mb-3">
                                ...
                                <div class="position-relative country-select">
                                    <select class="form-select bg-theme-color4 p-3 ps-5 pe-4 fw-semibold"
                                        style="appearance: none;">
                                        <option> UK Version </option>
                                    </select>
                                    <i class="fas fa-map-marker-alt position-absolute top-50 start-0 translate-middle-y ms-3 text-dark"
                                        style="font-size: 14px;"></i>
                                    <i class="fas fa-chevron-down position-absolute top-50 end-0 translate-middle-y me-3 text-dark"
