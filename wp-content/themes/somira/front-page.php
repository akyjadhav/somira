...
<section class="hero-section position-relative text-white">
  ...
  <div class="video-bg">
    <video autoplay muted loop playsinline>
      <source src="<?= get_template_directory_uri() . '/assets/img/' ?>MassagerReveal.mp4" type="video/mp4">
  ...
  <div class="container text-center">
    <div class="row justify-content-center align-items-center g-4">
      ...
      <div class="col-3 col-sm-3 col-md-2 text-center">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>healthcare.png" alt="Healthline" class="img-fluid"
          style="max-height: 28px;">
      </div>
      <div class="col-3 col-sm-3 col-md-2 text-center">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>cbs1.png" alt="CBS" class="img-fluid"
          style="max-height: 28px;">
      </div>
      <div class="col-3 col-sm-3 col-md-2 text-center">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>gq12.png" alt="GQ" class="img-fluid"
          style="max-height: 28px;">
      </div>
      <div class="col-3 col-sm-3 col-md-2 text-center">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>forbes.png" alt="Forbes" class="img-fluid"
          style="max-height: 28px;">
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row align-items-start">
      ...
      <div class="col-sm-6 mb-4 mb-sm-0 text-center">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>earth.png" alt="Globe" class="img-fluid rounded">
      </div>
    ...
    <div class="mobile feature-scroll-container d-md-none">
      <div class="col-md-4 feature-card">
        <div class="feature-box bg-theme-color2">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>p1.png" alt="Heat Therapy">
        </div>
      ...
      <div class="col-md-4 feature-card">
        <div class="feature-box bg-theme-color2">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>p2.webp" alt="Heat Therapy">
        </div>
      ...
      <div class="col-md-4 feature-card">
        <div class="feature-box bg-theme-color2">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>p3.webp" alt="Red Light Therapy">
        </div>
      ...
      <div class="col-md-4 feature-card">
        <div class="feature-box bg-theme-color2">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>p4.png" alt="Smart Controls">
        </div>
      ...
      <div class="col-md-4 feature-card">
        <div class="feature-box bg-theme-color2">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>p5.png" alt="High Quality Material">
        </div>
      ...
      <div class="col-md-4 feature-card">
        <div class="feature-box bg-theme-color2">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>p6.png" alt="Extended Arm Rest Design">
        </div>
...
<section class="complex-problems bg-theme-color1">
  <div class="container">
    <h2 class="section-title">Complex Problems.<span class="breakline"><span class="color1">Simple,</span><strong>Smart
          Solutions.</strong></span></h2>

    <div class="mobile complex-problems-scroll-container d-md-none">
      <div class="col-md-4 solution-card">
        <div class="solution-icon"><img src="<?= get_template_directory_uri() . '/assets/img/' ?>s1.png"></div>
      ...
      <div class="col-md-4 solution-card">
        <div class="solution-icon"><img src="<?= get_template_directory_uri() . '/assets/img/' ?>s2.png"></div>
        <div class="solution-content">
      ...
      <div class="col-md-4 solution-card">
        <div class="solution-icon"><img src="<?= get_template_directory_uri() . '/assets/img/' ?>s3.png"></div>
        <div class="solution-content">
      ...
      <div class="col-md-4 solution-card">
        <div class="solution-icon"><img src="<?= get_template_directory_uri() . '/assets/img/' ?>s4.png"></div>
        <div class="solution-content">
      ...
      <div class="col-md-4 solution-card">
        <div class="solution-icon"><img src="<?= get_template_directory_uri() . '/assets/img/' ?>s5.png"></div>
        <div class="solution-content">
      ...
      <div class="col-md-4 solution-card">
        <div class="solution-icon"><img src="<?= get_template_directory_uri() . '/assets/img/' ?>s6.png"></div>
        <div class="solution-content">
        ...
        <div id="productCarousel" class="carousel slide " data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="<?= get_template_directory_uri() . '/assets/img/' ?>product.png" class="d-block w-100"
                alt="Massager Image 1">
            </div>
          </div>
    ...
    <div class="mobile market-research-scroll-container d-md-none">
      <div class="col-md-4 market-card">
        <div class="p-4 rounded-4 h-100 bg-theme-color3 market-content">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>penn.png" alt="Penn Logo" class="mb-3">
      ...
      <div class="col-md-4 market-card">
        <div class="p-4 rounded-4 h-100 bg-theme-color3 market-content">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>cambridge.png" alt="Cambridge Logo" class="mb-3">
      ...
      <div class="col-md-4 market-card">
        <div class="p-4 rounded-4 h-100 bg-theme-color3 market-content">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>penn.png" alt="UGA Logo" class="mb-3">
    ...
    <div class="mobile testimonials-scroll-container d-md-none">
      <div class="col-md-4 testimonials-card">
        <div class="p-4 rounded-4 position-relative h-100 bg-theme-color3">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>t1.jpg" alt="Alyssa" class="rounded-circle mb-3">
      ...
      <div class="col-md-4 testimonials-card">
        <div class="p-4 rounded-4 position-relative h-100 bg-theme-color3 ">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>t2.jpg" alt="George" class="rounded-circle mb-3">
          <div class="position-absolute top-0 end-0 m-3">
            <i class="quote fas fa-quote-right position-absolute top-0 end-0 m-3 color2"></i>
          </div>
          <div class="d-flex align-items-center gap-2 mb-1  mt-1">
      ...
      <div class="col-md-4 testimonials-card">
        <div class="p-4 rounded-4 position-relative h-100 bg-theme-color3 ">
          <img src="<?= get_template_directory_uri() . '/assets/img/' ?>t3.jpg" alt="Hannah"
            class="rounded-circle mb-3 mt-1">
          <div class="position-absolute top-0 end-0 m-3">
            <i class="quote fas fa-quote-right position-absolute top-0 end-0 m-3 color2"></i>
          </div>
...
<section class="explore bg-theme-color1">
  <div class="container">
    ...
    <div class="custom-image-grid mobile comparison-scroll-container d-md-none">
      <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use5.jpg" alt="Foot massage">
      <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use1.jpg" alt="Top view of product">
      <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use7.jpg" alt="Red light therapy">
      <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use2.jpg" alt="Back massage">
      <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use3.jpg" alt="Car usage">
      <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use6.jpg" alt="Neck massage">
    </div>

    <div class="row desktop  d-none d-md-block">
      <div class="col-lg-5 col-md-12 mb-5 mb-lg-0">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use5.jpg" class="w-100 shadow-1-strong rounded mb-4"
          alt="Boat on Calm Water" />

        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use2.jpg" class="w-100 shadow-1-strong rounded mb-4"
          alt="Wintry Mountain Landscape" />
      </div>
      <div class="col-lg-3 col-md-12 mb-3 mb-lg-0">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use1.jpg" class="w-100 shadow-1-strong rounded mb-4"
          alt="Boat on Calm Water" />

        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use3.jpg" class="w-100 shadow-1-strong rounded mb-4"
          alt="Wintry Mountain Landscape" />
      </div>
      <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use7.jpg" class="w-100 shadow-1-strong rounded mb-4"
          alt="Boat on Calm Water" />

        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>use6.jpg" class="w-100 shadow-1-strong rounded mb-4"
          alt="Wintry Mountain Landscape" />
      </div>
    </div>
  ...
  <div class="container accordion-container">
    <div class="row">
      ...
      <div class="col-md-5 img-box pt-5 bg-theme-color2 d-flex align-items-end justify-content-center">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>about.png" alt="Founders"
          class="img-fluid align-self-end pt-4" style="max-height: 500px;">
      </div>
  ...
  <div class="container">
    ...
    <div class="mobile insights-scroll-container d-md-none">
      <div class="insight-card">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>insights1.png" alt="Insight 1">
      ...
      <div class="insight-card">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>insights2.png" alt="Insight 2">
        <div class="insight-content">
          <div class="insight-date">30 May, 2025</div>
      ...
      <div class="insight-card">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>insights3.png" alt="Insight 3">
        <div class="insight-content">
          <div class="insight-date">30 May, 2025</div>
    ...
    <div class="insights-row desktop d-none d-md-block">
      ...
      <div class="insight-card">
        <img src="<?= get_template_directory_uri() . '/assets/img/' ?>insights3.png" alt="Insight 3">
        <div class="insight-content">assets/img
          <div class="insight-date">30 May, 2025</div>
          <div class="insight-title">Tips for a Healthier Posture While Working</div>
        </div>
      </div>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <form class="contact-form">
          ...
          <div class="mb-3">
            <textarea class="form-control bg-theme-color1" placeholder="Enter message" required></textarea>
          </div>
          <div class="text-center">
            <button type="submit"
